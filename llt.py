...
parser = argparse.ArgumentParser(
    description='Convert a TeX file to PDF using lualatex.'
)
parser.add_argument(
    'tex',
    type=str,
...
parser.add_argument(
    ...
    action='store_true',
    default=False,
    help='lualatex does not halt even with syntax errors.'
)
parser.add_argument(
    '-s',
    dest='ShellEscape',
    action='store_true',
    default=False,
    help='Allow an external program to run during a lualatex run.'
)
parser.add_argument(
    '-w',
    dest='TwiceCompile',
...
# Compile
cmd_tex = 'powershell -command lualatex' + CompileMode + tex
